...
void testManyRemovals()
{
    ...
    tree.insert(71, "data for 71");
    tree.insert(82, "data for 82");
    tree.remove(95); //cout<<"95"<<endl;
    tree.remove(94);//cout<<"94"<<endl;    
    tree.remove(61);//cout<<"61"<<endl;    
    tree.remove(76);//cout<<"76"<<endl;    
    tree.remove(73);//cout<<"73"<<endl;   
    tree.remove(71);//cout<<"71"<<endl;  
    tree.print();
    printEnd();
}
